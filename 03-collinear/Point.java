...
//        LineSegment l = new LineSegment(new Point(1,1), new Point(1000,-1000));
//        l.draw();
...
//        for (Point p: points) System.out.println(p);
        BruteCollinearPoints l = new BruteCollinearPoints(points);
        for (LineSegment s : l.segments()) System.out.println(s);
        System.out.println(l.numberOfSegments());
    }
}
